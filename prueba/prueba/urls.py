...
urlpatterns = [
    ...
    path('eliminarRegistro/<matricula>/',views_registros.eliminarRegistro,name="eliminarRegistro"),
    path('formEditarRegistro/<matricula>/',views_registros.consultarEditarRegistro, name="ConsultaIn"),
    path('editarRegistro/<matricula>/',views_registros.editarRegistro,name="editarRegistro"),
    path('comentarios/',views_registros.contactocom, name="Comentarios"),
    ...
    path('formEditarComentario/<int:id>/', views_registros.consultarEditarComentario, name='ConsultaIndividual'),
